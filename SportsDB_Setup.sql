...
(
    ...
    FG_3P_Made SMALLINT NOT NULL,
    FG_3P_Attempted SMALLINT NOT NULL,
    ...
    CONSTRAINT "PK_Totals_Composite" PRIMARY KEY(Player_ID,Team_ID,Season),
    -- This connects to the teams table which acts as a bridge table
...
(
    ...
    FG_3P_Made REAL NOT NULL,
    FG_3P_Attempted REAL NOT NULL,
